...
public class SpokenEnglishActivity extends AppCompatActivity implements SpokenAdapter.OnSubCateListener {

    String TAG = CommunicationActivity.class.getSimpleName();
    //List<PlaylistItems> items;

    String YouTubeAPIChannelId = "UCrcPCuPv0X4Lr3tommVK0lQ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            adapter = new SpokenAdapter(SpokenEnglishActivity.this);
    ...
    public void OnSubCateClick(int position) {
        ...
        if(position == 0){
            Intent intent = new Intent(SpokenEnglishActivity.this,VideoActivity.class);
            intent.putExtra("playlistId", adapter.getPlaylistId(position));
            intent.putExtra("videoName","Spoken English");
